...
This version of MPV-MCTS uses a non-stationary multiarm bandit algorithm called
...
from open_spiel.python.algorithms.metacontroller import mcts_metacontroller as mcts
from open_spiel.python.algorithms.metacontroller import evaluator as evaluator_lib
from open_spiel.python.algorithms.metacontroller import model as model_lib
import pyspiel
...
def config_split(config):
    ...
    config_1 = ConfigModel(
        ...
        greedy_e=config.greedy_e_1,
        tau_c=config.tau_c_1,
    ...
    config_2 = ConfigModel(
        ...
        greedy_e=config.greedy_e_2,
        tau_c=config.tau_c_2,
...
def _init_bot(config, game, evaluator_, evaluation):
    ...
    return mcts.MCTSBot(
        ...
        child_selection_fn=mcts.SearchNode.slide_uct_value,
        verbose=False)
